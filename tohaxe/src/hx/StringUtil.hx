...
class StringUtil
{
    ...
    public static function ReplaceWordsInLine(line:String, target:String, replace:String, bTrimEnd:Bool = true):Array<String>
    {
        ...
        var newline:String = StringUtil.FindNewLineChar(replace2);
        if (newline == null)
        {
        ...
        var replines:Array<String> = bTrimEnd ? StringUtil.SplitTrimEnd(replace2, 10) : StringUtil.SplitTrim(replace2, 10);
        var firstspace:String = RegexUtil.Get1stMatch("^\\s", line);
    ...
    public static function SplitComma(i:String):Array<String>
    {
        ...
        { //for
            ...
            while (loop <= 100)
            {
                ...
                var f:String = RegexUtil.Get1stMatch(regex, tb);
    ...
    public static function SplitApiArges(buf:String, api:CsRef<String>, args:CsRef<Array<String>>, error:CsRef<String>):Bool
    {
        ...
        var arglist:Array<String> = StringUtil.SplitComma(argstr);
        if (arglist == null)
        {
