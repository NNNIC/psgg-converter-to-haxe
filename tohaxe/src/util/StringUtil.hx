...
class StringUtil
{
    ...
    public static function ReplaceWordsInLine(line:String, target:String, replace:String, bTrimEnd:Bool = true):Array<String>
    {
        ...
        var newline:String = util.StringUtil.FindNewLineChar(replace2);
        if (newline == null)
        {
        ...
        var replines:Array<String> = bTrimEnd ? util.StringUtil.SplitTrimEnd(replace2, 10) : util.StringUtil.SplitTrim(replace2, 10);
        var firstspace:String = util.RegexUtil.Get1stMatch("^\\s", line);
    ...
    public static function SplitComma(i:String):Array<String>
    {
        ...
        { //for
            ...
            while (loop <= 100)
            {
                ...
                var f:String = util.RegexUtil.Get1stMatch(regex, tb);
    ...
    public static function SplitApiArges(buf:String, api:CsRef<String>, args:CsRef<Array<String>>, error:CsRef<String>):Bool
    {
        ...
        var arglist:Array<String> = util.StringUtil.SplitComma(argstr);
        if (arglist == null)
        {
    ...
    public static function SplittComma_And_ApiArges(s:String):Array<String>
    {
        ...
        util.StringUtil.SplitApiArges(s, api, args, error);
        if (!system.Cs2Hx.IsNullOrEmpty(error.Value) || system.Cs2Hx.StringContains(api.Value, ","))
        {
            api.Value = null;
            args.Value = util.StringUtil.SplitComma(s);
        }
        else
        {
            if (args.Value == null)
